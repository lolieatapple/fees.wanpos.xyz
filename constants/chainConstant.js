// Format for each row:
// [ constant, coin-symbol, coin-name ]
export const chainIds = [
  ...
  ,[0x8000003c, 'ETH', 'Ethereum']
  ,[0x8000003d, 'ETC', 'Ethereum Classic']
  ...
  ,[0x80000266, 'OETH', '	Optimistic Ethereum']
  ...
  ,[0x40000001, 'MOVR', 'Moonriver']
  ,[0x40000002, 'ARETH', 'Arbitrum']
  ,[0x40000003, 'ADAE', 'Cardano']
  ,[0x40000004, 'GLMR', 'Moonbeam']
  // ,global.testnet ? [0x40000001, 'GLMR', 'Moonbeam'] : [0x40000004, 'GLMR', 'Moonbeam']
  ,[0x40000005, 'CLV', 'Clover Parachain']
  ,[0x40000006, 'FX', 'Function X']
  ,[0x40000007, 'PHA', 'Phala']
  ,[0x40000008, 'APT', 'APTOS']
  ,[0x40000009, 'GTH', 'Gather Chain']
]
